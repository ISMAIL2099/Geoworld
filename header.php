      ...
      <ul class="navbar-nav mr-auto">
        ...
        <li class="nav-item dropdown">
          <a class="nav-link dropdown-toggle" href="#" id="dropdown01" data-toggle="dropdown" aria-haspopup="true"
             aria-expanded="false">contnients</a>
          <div class="dropdown-menu" aria-labelledby="dropdown01"> 
            
            <?php $b_continent =getContinent(); ?>
            <?php foreach($b_continent as $lescontinent) : ?>                       
            <a class="dropdown-item" href="index2.php?continent=<?php echo $lescontinent->Continent ;?>"><?php echo $lescontinent-> Continent;?></a>
            <?php endforeach;?>
